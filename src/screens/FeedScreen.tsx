...
const s=StyleSheet.create({
 ...
 card:{height:FEED_H,backgroundColor:'#090909'},fallback:{backgroundColor:'#111',alignItems:'center',justifyContent:'center'},fallbackTxt:{color:'#222',fontSize:44,fontWeight:'900',letterSpacing:4},scrim:{position:'absolute',top:0,left:0,right:0,bottom:0,backgroundColor:'rgba(0,0,0,.22)'},badge:{position:'absolute',top:64,left:16,borderWidth:1,borderRadius:R.pill,paddingHorizontal:10,paddingVertical:5,backgroundColor:'rgba(0,0,0,.5)'},badgeTxt:{fontSize:9,fontWeight:'900',letterSpacing:.9},
